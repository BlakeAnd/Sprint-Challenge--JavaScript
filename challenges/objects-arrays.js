...
function popSmall(pop){
  return pop.population < 5;
}
largerPopulation = zooAnimals.filter(popSmall);
...
function addUp(total, add){
  total = total + add.population;
  return total;
}
populationTotal = zooAnimals.reduce(addUp, 0);
